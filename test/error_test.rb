...
class SabreDevStudio::ErrorTests < Test::Unit::TestCase
  ...
  def test_canned_response_400
    assert_raise SabreDevStudio::BadRequest do
      url = '/v2/shop/flights/fares?origin=ATL&destination=LAS'
  ...
  def test_401_retry
    url = "/v2/shop/themes?"
    token_url = "https://VjE6VVNFUjpHUk9VUDpET01BSU4%3D:UEFTU1dPUkQ%3D@api.test.sabre.com/v2/auth/token"
